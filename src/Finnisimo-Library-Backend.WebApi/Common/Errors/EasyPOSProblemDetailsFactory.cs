...
namespace Finnisimo_Library_Backend.WebApi.Common.Errors;

public class EasyPOSProblemDetailsFactory(ApiBehaviorOptions options)
    : ProblemDetailsFactory
{
                                           ...
                                           int statusCode)
  {
    ...
    if (httpContext.Items.TryGetValue(HttpContextItemKeys.Errors,
                                      out var errorsObj) &&
        errorsObj is List<Error> errors && errors.Count != 0)
    {
